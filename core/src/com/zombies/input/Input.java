package com.zombies.input;

import com.badlogic.gdx.scenes.scene2d.InputEvent;
import com.badlogic.gdx.scenes.scene2d.InputListener;
import com.zombies.exceptions.IllegalKeyCodeException;
...
public class Input extends InputListener {
    ...
    public static boolean keyDown(int keyCode) {
        if (keyCode > 349 || keyCode < 0) {
            throw new IllegalKeyCodeException();
        }
        return instance.keysDown[keyCode];
    }
